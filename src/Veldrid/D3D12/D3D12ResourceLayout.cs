...
namespace Veldrid.D3D12
{
    ...
    internal class D3D12ResourceLayout : ResourceLayout
    {
            ...
            : base(ref description)
        {
            ...
            Elements = Util.ShallowClone(elements);
        ...
        {
            if (resourceLayoutIndex >= bindingInfosByVdIndex.Length)
                throw new VeldridException($"Invalid resource index: {resourceLayoutIndex}. Maximum is: {bindingInfosByVdIndex.Length - 1}.");
